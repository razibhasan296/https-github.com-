...
import { LocationInfo, BotLockStatus, HistoryEntry, VisualStyle, MarkerData, ExplorationMode } from './types';
...
const VISUAL_STYLES: VisualStyle[] = ['Cinematic', 'Thermal', 'Night Vision', 'Cyberpunk', 'Deep Space', 'Post-Apocalyptic', 'Solar-Punk'];
const EXPLORATION_MODES: ExplorationMode[] = ['Street View', 'Satellite View', '3D City Model'];
            ...
            <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-slate-950/90 text-cyan-400 gap-6">
              ...
              <div className="flex flex-col items-center px-6">
                <div className="font-orbitron animate-pulse uppercase tracking-[0.4em] text-sm text-center">
                  {loading ? 'Synchronizing RAI Interface' : 'Recalibrating Visual Lens'}
                </div>
